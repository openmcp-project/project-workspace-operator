...
func (in *MemberOverridesSpec) DeepCopyInto(out *MemberOverridesSpec) {
	*out = *in
	if in.MemberOverrides != nil {
		...
		*out = make(MemberOverridesV2, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MemberOverridesV2) DeepCopyInto(out *MemberOverridesV2) {
	{
		in := &in
		*out = make(MemberOverridesV2, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemberOverridesV2.
func (in MemberOverridesV2) DeepCopy() MemberOverridesV2 {
	if in == nil {
		return nil
	}
	out := new(MemberOverridesV2)
	in.DeepCopyInto(out)
	return *out
}
